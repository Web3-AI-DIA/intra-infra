import { SuiMoveModule } from './moveParser';

export function generateSuiIndexerConfig(name: string, module: SuiMoveModule): any {
  return {
    name,
...
export function generateSuiRuntime(module: SuiMoveModule): string {
